...
const Expenses = () => {
  ...
  const [deleteTransaction, { isLoading: isDeleting,  }] =
    useDeleteTransactionMutation();
  const { data: expenses, isLoading } = useGetAllTransactionsQuery(user.userId);
                ...
                return (
                  ...
                  >
                    ...
                    {expense?.type === "income" ? (
                      ...
                      >
                        {isDeleting ? (
                          <div role="status"className="w-full h-full">
                            <svg
                              aria-hidden="true"
                              className="inline w-3 h-3 text-gray-200 animate-spin dark:text-gray-600 fill-red-600"
                              viewBox="0 0 100 101"
                              fill="none"
